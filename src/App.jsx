    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
         ...
         <Route path="/search-doctors" element={<PrivateRoute><SearchDoctors /></PrivateRoute>} /><Route path="/book/:doctorId" element={<PrivateRoute><BookAppointment /></PrivateRoute>} /><Route path="/doctor-appointments" element={<PrivateRoute><DoctorAppointments /></PrivateRoute>} /><Route path="/my-appointments" element={<PrivateRoute><PatientAppointments /></PrivateRoute>} /><Route path="/symptom-checker" element={<PrivateRoute><SymptomChecker /></PrivateRoute>} /><Route path="/chat/:otherId" element={<PrivateRoute><Chat /></PrivateRoute>} /><Route path="/prescription/:appointmentId" element={<PrivateRoute><Prescription /></PrivateRoute>} />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
  );
