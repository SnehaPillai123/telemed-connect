          ...
          <div style={{ padding: '28px 32px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16, marginBottom: 28 }}>
              {[
                ...
                { label: 'With 24/7 Emergency', value: HOSPITALS.filter(h => h.emergency).length, color: '#dc2626' },
                ...
                <article key={i} className="hospital-card fade-in" style={{ animationDelay: `${i * 0.05}s`, opacity: 0 }}>
                  <div style={{ padding: '20px', borderBottom: '1px solid #f9fafb' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                      ...
                      {h.emergency && <span style={{ fontSize: 11, fontWeight: 700, color: '#dc2626', background: '#fef2f2', padding: '3px 10px', borderRadius: 20, border: '1px solid #fecaca', flexShrink: 0 }}>24/7 Emergency</span>}
                    </div>
                  ...
                  <div style={{ padding: '14px 20px', display: 'flex', gap: 10 }}>
                    ...
                    <a href={`https://www.google.com/maps/search/${encodeURIComponent(h.name)}`} target="_blank" rel="noreferrer"
                      style={{ padding: '9px 16px', background: 'white', color: '#374151', border: '1.5px solid #e5e7eb', borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                      Directions
                    </a>
                  </div>
                </article>
