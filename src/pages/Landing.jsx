    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { font-family:'Inter',sans-serif; box-sizing:border-box; margin:0; padding:0; }
        ...
        .btn-hero { padding:16px 36px; background:#0d9488; color:white; border:none; border-radius:12px; font-size:16px; font-weight:700; text-decoration:none; transition:all 0.2s; display:inline-flex; align-items:center; gap:10px; -webkit-tap-highlight-color:transparent; }
        .btn-hero:hover { background:#0f766e; transform:translateY(-2px); box-shadow:0 12px 32px rgba(13,148,136,0.3); }

        /* HERO — full width, no max-width cap on inner */
        ...
        .l-hero-inner { flex:1; display:flex; align-items:center; padding:32px 48px; width:100%; gap:48px; }
        .l-hero-left  { flex:1.1; }
        .l-hero-right { flex:0.9; display:flex; flex-direction:column; gap:14px; }
        .l-hero-badge { display:inline-flex; align-items:center; gap:8px; background:#f0fdfa; border:1px solid #ccfbf1; border-radius:50px; padding:7px 16px; margin-bottom:22px; }
        .l-hero-title { font-size:clamp(36px,5vw,72px); font-weight:900; color:#111827; line-height:1.05; letter-spacing:-0.03em; margin-bottom:22px; }
        .l-hero-title span { color:#0d9488; }
        .l-hero-desc  { font-size:clamp(15px,1.6vw,20px); color:#6b7280; line-height:1.75; margin-bottom:36px; max-width:560px; }

        /* Hero right cards — bigger on desktop */
        .l-hero-card { background:white; border-radius:16px; border:1px solid #e5e7eb; padding:20px; box-shadow:0 4px 24px rgba(0,0,0,0.07); }

        .l-stats { background:#0d9488; padding:36px 48px; }
        .l-stats-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:24px; }
        ...
        .l-section       { padding:80px 48px; }
        .l-section-inner { max-width:1400px; margin:0 auto; }
        .l-section-head  { text-align:center; margin-bottom:48px; }
        .l-emergency { background:linear-gradient(135deg,#7f1d1d,#991b1b); padding:72px 48px; text-align:center; }
        .l-footer        { background:#0f172a; padding:48px 48px 24px; }
        .l-footer-grid   { max-width:1400px; margin:0 auto; display:grid; grid-template-columns:2fr 1fr 1fr 1fr; gap:48px; margin-bottom:40px; }
        .l-footer-bottom { max-width:1400px; margin:0 auto; padding-top:24px; border-top:1px solid rgba(255,255,255,0.1); display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; }
        ...
        @media screen and (max-width:768px) {
          ...
          .l-hero-title { font-size:clamp(32px,8vw,48px); }
          .btn-hero     { padding:14px 24px; font-size:15px; }
          .l-stats      { padding:28px 20px; }
          ...
          .l-footer       { padding:36px 20px 20px; }
        }
        @media screen and (min-width:769px) and (max-width:1024px) {
          .l-hero-inner    { padding:24px 32px; gap:32px; }
          ...
          .l-section       { padding:60px 32px; }
          .l-stats         { padding:32px; }
        }
      ...
      <div className={`l-mobile-menu ${menuOpen?'open':''}`}>
        ...
        <Link to="/register"
          ...
          onClick={() => setMenuOpen(false)}>Get started free</Link>
      </div>
          ...
          <div className="l-hero-left">
            ...
            <div className="fade-up d4" style={{ marginBottom:32 }}>
              <Link to="/register" className="btn-hero">
                Get started free
                <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
              </Link>
            </div>
            <div className="fade-up d4" style={{ display:'flex', alignItems:'center', gap:20, flexWrap:'wrap' }}>
              {[
                ...
                <div key={i} style={{ display:'flex', alignItems:'center', gap:7 }}>
                  <svg width="15" height="15" fill="none" viewBox="0 0 24 24"><path d={b.icon} stroke="#0d9488" strokeWidth="1.5" strokeLinecap="round"/></svg>
          ...
          <div className="l-hero-right">
            <div className="l-hero-card">
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:14 }}>
                <p style={{ fontSize:14, fontWeight:700, color:'#111827' }}>Upcoming Appointment</p>
                <span style={{ fontSize:11, fontWeight:600, color:'#0d9488', background:'#f0fdfa', padding:'4px 12px', borderRadius:20, border:'1px solid #ccfbf1' }}>Confirmed</span>
              </div>
              <div style={{ display:'flex', gap:12, alignItems:'center', marginBottom:12 }}>
                <div style={{ width:44, height:44, borderRadius:10, background:'#f0fdfa', border:'1px solid #ccfbf1', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                  <span style={{ fontSize:13, fontWeight:700, color:'#0d9488' }}>RK</span>
                </div>
                <div>
                  <p style={{ fontSize:14, fontWeight:700, color:'#111827' }}>Dr. Rajesh Kumar</p>
                  <p style={{ fontSize:12, color:'#6b7280' }}>Cardiologist · 10 yrs</p>
                </div>
              </div>
              <div style={{ display:'flex', gap:16 }}>
                <span style={{ fontSize:12, color:'#374151' }}>📅 Mon, 17 Mar 2026</span>
                <span style={{ fontSize:12, color:'#374151' }}>🕐 10:30 AM</span>
              </div>
            </div>

            <div style={{ background:'#f0fdfa', borderRadius:16, border:'1px solid #ccfbf1', padding:'20px', boxShadow:'0 4px 24px rgba(0,0,0,0.07)' }}>
              <p style={{ fontSize:11, fontWeight:700, color:'#0d9488', textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:8 }}>AI Health Tip</p>
              <p style={{ fontSize:14, color:'#374151', lineHeight:1.7 }}>A 10-minute walk after meals can reduce blood sugar levels by up to 22%.</p>
            </div>

            <div style={{ background:'#fef2f2', borderRadius:16, border:'1px solid #fecaca', padding:'20px', boxShadow:'0 4px 24px rgba(0,0,0,0.07)' }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                <div>
                  <p style={{ fontSize:14, fontWeight:700, color:'#dc2626', marginBottom:5 }}>Emergency SOS</p>
                  <p style={{ fontSize:12, color:'#991b1b' }}>One tap — alerts hospitals & shares location</p>
                </div>
                <div style={{ width:44, height:44, borderRadius:11, background:'#ef4444', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
      ...
      <section className="l-stats">
        <div className="l-stats-grid" style={{ maxWidth:1400, margin:'0 auto' }}>
          {STATS.map((s,i) => (
            <div key={i} style={{ textAlign:'center' }}>
              <p style={{ fontSize:'clamp(28px,5vw,44px)', fontWeight:900, color:'white', lineHeight:1, marginBottom:6 }}>
                <AnimatedCounter target={s.value} suffix={s.suffix}/>
              </p>
              <p style={{ fontSize:14, color:'rgba(255,255,255,0.8)', fontWeight:500 }}>{s.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="l-section" style={{ background:'#f9fafb' }}>
        <div className="l-section-inner">
          <div className="l-section-head">
            ...
            <h2 style={{ fontSize:'clamp(24px,4vw,44px)', fontWeight:800, color:'#111827', letterSpacing:'-0.02em', marginBottom:14, lineHeight:1.2 }}>Everything you need,<br/>nothing you don't.</h2>
            ...
            {FEATURES.map((f,i) => (
              <article key={i} className="l-feature-card">
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:14 }}>
                  <div style={{ width:48, height:48, borderRadius:12, background:'#f0fdfa', border:'1px solid #ccfbf1', display:'flex', alignItems:'center', justifyContent:'center' }}>
                    <svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path d={f.icon} stroke="#0d9488" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
      ...
      <section id="how-it-works" className="l-section" style={{ background:'white' }}>
        <div className="l-section-inner">
          <div className="l-section-head">
            ...
            <h2 style={{ fontSize:'clamp(24px,4vw,44px)', fontWeight:800, color:'#111827', letterSpacing:'-0.02em', lineHeight:1.2 }}>From symptom to solution<br/>in minutes.</h2>
          </div>
      ...
      <section id="specializations" className="l-section" style={{ background:'#f9fafb' }}>
        <div className="l-section-inner">
          <div className="l-section-head">
            ...
            <h2 style={{ fontSize:'clamp(22px,3vw,40px)', fontWeight:800, color:'#111827', letterSpacing:'-0.02em', marginBottom:10, lineHeight:1.2 }}>Whatever you need, we have a specialist.</h2>
          ...
          <div style={{ textAlign:'center' }}>
            <Link to="/register" style={{ padding:'14px 32px', background:'#0d9488', color:'white', borderRadius:12, fontSize:15, fontWeight:700, textDecoration:'none', display:'inline-block' }}>
      ...
      <section id="emergency" className="l-emergency">
        <div style={{ maxWidth:700, margin:'0 auto' }}>
          <div style={{ width:64, height:64, borderRadius:16, background:'rgba(255,255,255,0.15)', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 20px' }}>
            <svg width="30" height="30" fill="none" viewBox="0 0 24 24"><path d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" stroke="white" strokeWidth="1.8" strokeLinecap="round"/></svg>
          </div>
          <h2 style={{ fontSize:'clamp(24px,4vw,48px)', fontWeight:800, color:'white', marginBottom:14, letterSpacing:'-0.02em', lineHeight:1.2 }}>
            Medical emergency?<br/>One tap is all it takes.
          </h2>
          <p style={{ fontSize:'clamp(14px,2vw,18px)', color:'rgba(255,255,255,0.8)', marginBottom:32, lineHeight:1.7 }}>
            Our Emergency SOS feature instantly shares your GPS location with nearby hospitals — even when you can't speak.
          </p>
          <Link to="/register" style={{ padding:'15px 40px', background:'white', color:'#dc2626', borderRadius:12, fontSize:15, fontWeight:800, textDecoration:'none', display:'inline-block' }}>
