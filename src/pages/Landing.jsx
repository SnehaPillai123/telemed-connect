...
const FEATURES = [
  ...
  { icon: 'M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z', title: "Smart Consultation Snapshot", desc: "Upload a photo of your symptom — rash, swelling, wound. The doctor sees it before consultation for faster diagnosis.", badge: "Unique" },
  { icon: 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', title: "Ask Before You Book", desc: "Not sure if you need a doctor? Answer 5 quick questions and get instant guidance — consult now or self-care.", badge: "Smart" },
  { icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', title: "Digital Prescriptions", desc: "Doctors write prescriptions digitally. Patients can view and order medicines from 1mg or PharmEasy instantly.", badge: "" },
  { icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9', title: "Emergency SOS", desc: "One tap activates emergency mode — shares your real-time GPS location with nearby hospitals and emergency contacts.", badge: "Critical" },
  { icon: 'M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129', title: "Multilingual Support", desc: "Consult in your language. Our platform supports 8+ Indian languages with real-time translation built in.", badge: "" },
];
    ...
    <>
      <style>{`
        ...
        * { font-family: 'Inter', sans-serif; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .feature-card { background: white; border-radius: 16px; border: 1px solid #e5e7eb; padding: 28px; transition: all 0.25s; }
        ...
        .emergency-banner { background: linear-gradient(135deg, #7f1d1d, #991b1b); padding: 80px 60px; text-align: center; }
      ...
      <section className="hero">
        <div style={{ position: 'absolute', top: 80, right: '5%', width: 400, height: 400, borderRadius: '50%', background: 'rgba(13,148,136,0.06)', filter: 'blur(60px)', pointerEvents: 'none' }}/>
        <div style={{ position: 'absolute', bottom: 100, left: '3%', width: 300, height: 300, borderRadius: '50%', background: 'rgba(2,132,199,0.05)', filter: 'blur(40px)', pointerEvents: 'none' }}/>
        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <div className="fade-up delay-4" style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: 40 }}>
            ...
            <div className="fade-up delay-4" style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <svg width="15" height="15" fill="none" viewBox="0 0 24 24">
                    <path d={b.icon} stroke="#0d9488" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
          ...
          <div className="hero-right">
            ...
            <div style={{ background: 'white', borderRadius: 16, border: '1px solid #e5e7eb', padding: '20px', boxShadow: '0 8px 32px rgba(0,0,0,0.08)' }}>
              <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                <div style={{ width: 38, height: 38, borderRadius: 9, background: '#f0fdfa', border: '1px solid #ccfbf1', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <svg width="17" height="17" fill="none" viewBox="0 0 24 24"><path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" stroke="#0d9488" strokeWidth="1.8" strokeLinecap="round"/></svg>
                </div>
                <div>
                  <p style={{ fontSize: 11, fontWeight: 700, color: '#0d9488', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 4 }}>AI Health Tip</p>
            ...
            <div style={{ background: '#fef2f2', borderRadius: 16, border: '1px solid #fecaca', padding: '20px', boxShadow: '0 8px 32px rgba(0,0,0,0.08)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ width: 42, height: 42, borderRadius: 10, background: '#ef4444', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      ...
      {/* FEATURES */}
      <section id="features" style={{ padding: '100px 60px', background: '#f9fafb' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px,4vw,48px)', fontWeight: 800, color: '#111827', letterSpacing: '-0.02em', marginBottom: 16 }}>Everything you need,<br/>nothing you don't.</h2>
            <p style={{ fontSize: 18, color: '#6b7280', maxWidth: 560, margin: '0 auto', lineHeight: 1.7 }}>Built for patients who want convenience and doctors who want efficiency.</p>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20 }}>
            {FEATURES.map((f, i) => (
              <article key={i} className="feature-card">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                  <div style={{ width: 50, height: 50, borderRadius: 12, background: '#f0fdfa', border: '1px solid #ccfbf1', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                      <path d={f.icon} stroke="#0d9488" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  {f.badge && <span style={{ fontSize: 11, fontWeight: 700, color: '#0d9488', background: '#f0fdfa', padding: '3px 10px', borderRadius: 20, border: '1px solid #ccfbf1' }}>{f.badge}</span>}
                </div>
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" style={{ padding: '100px 60px', background: 'white' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px,4vw,48px)', fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>From symptom to solution<br/>in minutes.</h2>
          </div>
      ...
      {/* SPECIALIZATIONS */}
      <section id="specializations" style={{ padding: '80px 60px', background: '#f9fafb' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2 style={{ fontSize: 'clamp(24px,3vw,40px)', fontWeight: 800, color: '#111827', letterSpacing: '-0.02em', marginBottom: 12 }}>Whatever you need, we have a specialist.</h2>
