                    ...
                    {rx.medicines?.map((med,i) => (
                      <div key={i} style={{ border:'1px solid #e5e7eb', borderRadius:9, padding:14 }}>
                        ...
                        <div style={{ marginTop:8 }}>
                          <button onClick={() => navigate('/prescription-pdf/' + rx.id)} style={{ fontSize:11, fontWeight:600, color:'#2563eb', background:'#eff6ff', border:'1px solid #bfdbfe', borderRadius:6, padding:'4px 10px', cursor:'pointer' }}>
                            📄 Download PDF
                          </button>
                        </div>
                      </div>
